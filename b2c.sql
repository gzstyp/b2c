...
CREATE TABLE `product`  (
  ...
  `product_sale_model` int(0) NOT NULL COMMENT '销售模式（1：现货销售；2：预售模式）--必填项',
  ...
  `product_sale_num` int(0) NULL DEFAULT NULL COMMENT '销量',
  `product_type_id` int(0) NOT NULL COMMENT '商品分类ID-外键--必选项',
  ...
  `product_video_id` int(0) NULL DEFAULT NULL COMMENT '商品视频-URL地址（单个视频）-外键',
  ...
  `product_sale_unit_id` int(0) NULL DEFAULT NULL COMMENT '商品单位（如：市场价：20元/公斤）',
  ...
  `product_amount` int(0) NULL DEFAULT NULL COMMENT '库存总数量（后台可更新【增加-减少】）',
  `product_standards` decimal(8, 2) NULL DEFAULT NULL COMMENT '规格',
  `product_amount_unit_id` int(0) NULL DEFAULT NULL COMMENT '重量单位-外键',
  `product_copies` int(0) NULL DEFAULT NULL COMMENT '份数',
  `product_volume` decimal(8, 2) NULL DEFAULT NULL COMMENT '体积',
  `product_volume_unit_id` int(0) NULL DEFAULT NULL COMMENT '体积单位-外键',
  `product_sale_model2_num` int(0) NULL DEFAULT NULL COMMENT '预售商品数量',
  `product_tag_id` int(0) NULL DEFAULT NULL COMMENT '商品标签-外键',
  `product_state` int(0) NULL DEFAULT NULL COMMENT '商品状态（1：上架、0：下架0，2：售完）【可通过时间控制：发布即上架、发布不上架、设置一个时间上架】',
  `product_information` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '商品详细描述信息',
  `product_view_num` int(0) NULL DEFAULT NULL COMMENT '访问量',
...
CREATE TABLE `product_attributes`  (
  `id` int(0) NOT NULL AUTO_INCREMENT COMMENT '商品属性ID',
  `product_attributes_name` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '商品属性名称',
  `product_attributes_sort` int(0) NULL DEFAULT NULL COMMENT '排序',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `product_review`  (
  ...
  `review_stars` int(0) NULL DEFAULT NULL COMMENT '等级【1~5等级】',
  `review_img_id` int(0) NULL DEFAULT NULL COMMENT '用户晒图ID',
  `review_vidoe_id` int(0) NULL DEFAULT NULL COMMENT '用户晒短视频ID',
  `review_from` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '来源（1移动端、PC端【预留】）',
  `review_perent_id` int(0) NULL DEFAULT NULL COMMENT '父节点ID【追评使用】',
  `review_likes` int(0) NULL DEFAULT NULL COMMENT '点赞数量',
  ...
  `review_state` int(0) NULL DEFAULT NULL COMMENT '状态',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `product_tag`  (
  ...
  `product_tag_sort` int(0) NULL DEFAULT NULL COMMENT '排序',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `product_type`  (
  ...
  `product_type_perent_id` int(0) NOT NULL COMMENT '父节点ID（如果是顶级则是0）',
  `product_type_sort` int(0) NULL DEFAULT NULL COMMENT '排序',
  `product_type_state` int(0) NULL DEFAULT NULL COMMENT '状态（1：可用；0：不可用；）',
  `product_type_img_id` int(0) NULL DEFAULT NULL COMMENT '分类图片【可以带图片】',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `resource`  (
  `id` int(0) NOT NULL AUTO_INCREMENT COMMENT '唯一ID',
  `type_id` int(0) NULL DEFAULT NULL COMMENT '资源类型ID-外键',
  ...
  `resource_state` int(0) NULL DEFAULT NULL COMMENT '资源状态',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `resource_type`  (
  ...
  `resource_type_sort` int(0) NULL DEFAULT NULL COMMENT '排序',
...
INSERT INTO `sys_frontend_menu_table` VALUES ('40ca076892e16ef6f788eb4d753df964', '用户管理', 'sys/user.html', '0af385f5e237445d369a49cb35b20da4', 901, NULL);
...
INSERT INTO `sys_frontend_menu_table` VALUES ('b973d15c229778a6d98e742d096b2e41', '角色管理', 'sys/role1.html', '0af385f5e237445d369a49cb35b20da4', 902, '角色管理页面');
